  ...
  return (
    <section className="mx-auto max-w-5xl px-6 py-24">
      <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
        <div className="rounded-[2rem] border border-neutral-800/80 bg-neutral-900/80 p-12 shadow-2xl shadow-black/20">
          <p className="text-sm uppercase tracking-[0.3em] text-amber-400">Sign in</p>
          <h1 className="mt-6 text-4xl font-serif text-white">Welcome back to L&apos;Étoile Dorée.</h1>
          <p className="mt-4 max-w-xl text-neutral-400 leading-7">
        ...
        <form onSubmit={handleAuth} className="space-y-6 rounded-[2rem] border border-neutral-800/80 bg-neutral-950/85 p-10 shadow-xl shadow-black/20">
          <div className="space-y-2">
            ...
            <input type="email" required value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })} className="w-full rounded-2xl border border-neutral-800 bg-neutral-900 px-4 py-3 text-white outline-none focus:border-amber-500" />
          </div>
          <div className="space-y-2">
            <label className="text-xs uppercase tracking-wide text-neutral-400">Password</label>
            <input type="password" required value={form.password} onChange={(e) => setForm({ ...form, password: e.target.value })} className="w-full rounded-2xl border border-neutral-800 bg-neutral-900 px-4 py-3 text-white outline-none focus:border-amber-500" />
          </div>
          ...
          <p className="text-center text-sm text-neutral-500">
            ...
            <Link href="/signup" className="text-amber-400 hover:underline">Register</Link>
          </p>
        </form>
      </div>
    </section>
