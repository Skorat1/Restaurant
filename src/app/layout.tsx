...
export const metadata: Metadata = {
  ...
  title: {
    default: "L'Étoile Dorée | Premium Fine Dining Restaurant",
    template: "%s | L'Étoile Dorée",
  },
  description:
    "Experience ultra-modern premium gastronomy at L'Étoile Dorée. Seasonal tasting menus, private dining, sommelier pairings, and exclusive membership benefits.",
  keywords: ["fine dining", "restaurant", "tasting menu", "reservation", "private dining", "sommelier"],
  authors: [{ name: "L'Étoile Dorée" }],
  creator: "L'Étoile Dorée",
  openGraph: {
    type: "website",
    locale: "en_US",
    url: SITE_URL,
