...
export const metadata: Metadata = {
  ...
  title: {
    default: "VELORA | Premium Fine Dining Restaurant",
    template: "%s | VELORA",
  },
  description:
    "Experience ultra-modern premium gastronomy at VELORA. Seasonal tasting menus, private dining, sommelier pairings, and exclusive membership benefits.",
  keywords: ["fine dining", "restaurant", "tasting menu", "reservation", "private dining", "sommelier"],
  authors: [{ name: "VELORA" }],
  creator: "VELORA",
  openGraph: {
    type: "website",
    ...
    url: SITE_URL,
    siteName: "VELORA",
    title: "VELORA | Premium Fine Dining",
    description: "Seasonal tasting menus, private dining, and sommelier pairings in an intimate setting.",
    images: [{ url: "/images/hero.jpg", width: 1200, height: 630, alt: "VELORA Restaurant" }],
  },
  twitter: {
